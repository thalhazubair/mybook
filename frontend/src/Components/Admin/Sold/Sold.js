                ...
                <MDBListGroupItem style={{ color: "black" }}>
                  ...
                  >
                    ...
                    <div style={{ width: "50%" }}>
                      ...
                      >
                        Bids Made: {doc.last_bidded_member.length}
                      </h5>
                    </div>
                  </div>
                </MDBListGroupItem>
                  ...
                  >
                    <div style={{ width: "50%", textAlign: "left" }}>
                      ...
                      >
                        Buyer:
                        {
                          doc.last_bidded_member[
                            doc.last_bidded_member.length - 1
                          ]
                        }
                      </h5>
                    </div>
                ...
                <MDBListGroupItem>
                  ...
                  >
                    <div style={{ width: "100%", textAlign: "left" }}>
                      ...
                      >
                        Participants:
                        {[...new Set(doc.last_bidded_member)].join(",")}
                      </h5>
                    </div>
                  </div>
                </MDBListGroupItem>

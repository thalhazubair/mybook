...
function Card() {
  ...
  const handleAuthorFilter = (e) => {
    ...
    const newPacientes = book.filter(
      (value) => selectedAuthor === "" || value.authors.includes(selectedAuthor)
    );
  ...
  return (
    <div className="home-content">
      <div
        class="input-group"
        style={{ justifyContent: "end", right: "10px", bottom: "30px" }}
      >
      ...
      <div class="container-fluid">
        <h2 class="card-heading-novel">NOVEL</h2>
          ...
          {search === "" &&
            currentItems.map((item, index) => {
              ...
              return (
                <Link
                  to="/bookdetails"
                  state={{ thumbnail: thumbnail, title: title }}
                >
                  <div key={index} class="card card-body-home">
                    {" "}
